package com.ifsc.tds.alexsander.gabriel.gustavo.menu;

import com.ifsc.tds.alexsander.gabriel.gustavo.controller.MenuController;
...
public class Menu extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			// carregando o loader
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ifsc/tds/alexsander/gabriel/gustavo/view/Menu.fxml"));
			...
			menuJanela.setTitle("MENU DE SELE��O");
